...
extern "C"  void UnityWebRequest__ctor_m3895125645 (UnityWebRequest_t463507806 * __this, String_t* ___url0, String_t* ___method1, DownloadHandler_t2937767557 * ___downloadHandler2, UploadHandler_t2993558019 * ___uploadHandler3, const RuntimeMethod* method) IL2CPP_METHOD_ATTR;
...
extern "C" void UnityWebRequest_t463507806_marshal_pinvoke_back(const UnityWebRequest_t463507806_marshaled_pinvoke& marshaled, UnityWebRequest_t463507806& unmarshaled)
{
	...
	IL2CPP_RAISE_MANAGED_EXCEPTION(il2cpp_codegen_get_missing_method_exception("A parameterless constructor is required for type 'UnityEngine.Networking.UploadHandler'."));
...
// System.Void UnityEngine.Networking.UnityWebRequest::.ctor(System.String,System.String,UnityEngine.Networking.DownloadHandler,UnityEngine.Networking.UploadHandler)
extern "C"  void UnityWebRequest__ctor_m3895125645 (UnityWebRequest_t463507806 * __this, String_t* ___url0, String_t* ___method1, DownloadHandler_t2937767557 * ___downloadHandler2, UploadHandler_t2993558019 * ___uploadHandler3, const RuntimeMethod* method)
{
	{
		Object__ctor_m297566312(__this, /*hidden argument*/NULL);
...
extern "C"  AsyncOperation_t1445031843 * UnityWebRequest_Send_m637654012 (UnityWebRequest_t463507806 * __this, const RuntimeMethod* method)
{
...
extern "C"  UnityWebRequest_t463507806 * UnityWebRequest_Get_m996521828 (RuntimeObject * __this /* static, unused */, String_t* ___uri0, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
...
IL_00d6:
	...
	{
		IL2CPP_RUNTIME_CLASS_INIT(Encoding_t1523322056_il2cpp_TypeInfo_var);
		Encoding_t1523322056 * L_39 = Encoding_get_UTF8_m1008486739(NULL /*static, unused*/, /*hidden argument*/NULL);
		String_t* L_40 = ___targetUrl0;
		NullCheck(L_39);
		ByteU5BU5D_t4116647657* L_41 = VirtFuncInvoker1< ByteU5BU5D_t4116647657*, String_t* >::Invoke(10 /* System.Byte[] System.Text.Encoding::GetBytes(System.String) */, L_39, L_40);
		V_5 = L_41;
		ByteU5BU5D_t4116647657* L_42 = V_5;
		IL2CPP_RUNTIME_CLASS_INIT(WWWTranscoder_t272523958_il2cpp_TypeInfo_var);
		ByteU5BU5D_t4116647657* L_43 = WWWTranscoder_URLDecode_m3587034544(NULL /*static, unused*/, L_42, /*hidden argument*/NULL);
		V_6 = L_43;
		...
		NullCheck(L_44);
		String_t* L_46 = VirtFuncInvoker1< String_t*, ByteU5BU5D_t4116647657* >::Invoke(22 /* System.String System.Text.Encoding::GetString(System.Byte[]) */, L_44, L_45);
		V_0 = L_46;
		goto IL_014f;
	}
...
IL_0128:
	{
		String_t* L_48 = ___targetUrl0;
		NullCheck(L_48);
		bool L_49 = String_Contains_m1147431944(L_48, _stringLiteral3452614523, /*hidden argument*/NULL);
		if (!L_49)
		{
			goto IL_0143;
		}
	...
	{
		Uri_t100236324 * L_50 = V_2;
		NullCheck(L_50);
		String_t* L_51 = Uri_get_OriginalString_m3715995233(L_50, /*hidden argument*/NULL);
		G_B25_0 = L_51;
		goto IL_0149;
	}
...
IL_0143:
	{
		Uri_t100236324 * L_52 = V_2;
		NullCheck(L_52);
		String_t* L_53 = Uri_get_AbsoluteUri_m2582056986(L_52, /*hidden argument*/NULL);
		G_B25_0 = L_53;
	}
